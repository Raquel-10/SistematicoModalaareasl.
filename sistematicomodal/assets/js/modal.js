...
function ShowModalForEdit(sender){
	...
	document.getElementById('Profesiones').value=table.rows[SelectedRowIndex].cells[5].innerHTML.toString().trim();
	document.getElementById('HijosTextBox').value=table.rows[SelectedRowIndex].cells[6].innerHTML.toString().trim();
	//
...
function ActualizarRegistro(){
    if (ValidarCedula(document.getElementById('IDTextBox').value)){
		...
		table.rows[SelectedRowIndex].cells[5].innerHTML=document.getElementById('Profesiones').value;
          //
